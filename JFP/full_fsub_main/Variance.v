...
Lemma Tlookup_subst: forall A i X C T,
    type A ->
    rt_type A ->
...
Lemma Tlookup_subst_tl: forall A i X C T,
    type A ->
    rt_type A ->
...
Proof with auto.
  ...
  - apply sa_rcd...
    ...
    + rewrite_alist (map (subst_tb X Y) E1 ++ [(Y, bind_sub U)] ++ E2).
      apply WF_replacing...
    + intros. 
      apply Tlookup_subst in H9... 2:{ get_type... }
      apply Tlookup_subst in H10... 2:{ get_type... }
...
Proof with eauto.
  ...
  -
    ...
    + apply WF_renaming_tlb...
    + intros.
      apply Tlookup_subst_tl in H7... 2:{ get_type... }
      apply Tlookup_subst_tl in H8... 2:{ get_type... }
