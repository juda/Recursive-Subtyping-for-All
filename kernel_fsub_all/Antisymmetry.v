...
Lemma sub_tvar_inv:forall E U (X:atom),
    ...
    (exists G, binds X (bind_sub_lb G) E /\ sub E U G) \/  U = typ_bot.
Proof with auto.
  intros.
...
Proof with auto.
  ...
  - pose proof sub_regular H0. destruct_hypos.
    ...
    pose proof sub_tvar_inv  H0. destruct H5 as [[X' H5]|[H5|H5]].
    + subst U.
  ...
  - pose proof sub_regular H0. destruct_hypos.
    ...
    + subst. right. right. right. left. apply sa_trans_tvar_lb with (U:=typ_top)...
Qed.
